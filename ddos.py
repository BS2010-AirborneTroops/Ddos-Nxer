...
def logo():
    ...
    print(f"")
    print(f"")
    print(f"____   ___  _   _ _____ _  ______ ___ ____  _____ ____")
    print(f" | __ ) / _ \| \ | | ____| |/ / ___|_ _| __ )| ____|  _\")
    print(f" |  _ \| | | |  \| |  _| |   /\___ \| ||  _ \|  _| | |_) |")
    print(f" | |_) | |_| | |\  | |___| . \ ___) | || |_) | |___|  _ ")
    print(f" mas|____/ \___/|_| \_|_____|_|\_\____/___|____/|_____|_| \_\")   
